...
function setup() {
	...
	bob1 = Bodies.circle(300,400,50,boboptions);
	World.add(world,bob1);
	bob2 = Bodies.circle(350,400,50,boboptions);
	World.add(world,bob2);
	bob3 = Bodies.circle(400,400,50,boboptions);
	World.add(world,bob3);
	bob4 = Bodies.circle(450,400,50,boboptions);
	World.add(world,bob4);
	bob5 = Bodies.circle(500,400,50,boboptions);
...
function keyPressed(){
	if(keyCode === LEFT_ARROW){
		Matter.Body.applyForce(bob1,bob1.position,{x:-0.5,y:0});
	}
}